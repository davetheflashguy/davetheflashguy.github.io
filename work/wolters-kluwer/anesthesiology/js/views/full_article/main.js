      ...
      $.ajax({
        ...
        var DOM = "<div id='verticalScrollContainer"+_position+"' class='verticalScrollContainer' style='height:1024px; overflow:auto'>";
            ...
            DOM += "</div>";
             ...
             DOM = multiReplace(DOM, '<div id="ej-article-outline-top"><a href="#">Back to Top</a></div>', ""); // "the dog looks like a dog"
        ...
        $('sup a').each(function () {
            $('sup a').attr('href', 'javascript:void(0)');
        });

      

        $('span.ej-references-cited-here').each(function(){
