...
(function(window)
{
	 ...
	 * 
	 * 	@_playerContainer reference to the parent container
	 					  of the video player
	 *	@_config reference to the configuration file
	 */
	Player.prototype.embedPlayer = function(_playerContainer, _config)
	{
		Player.playerContainer = _playerContainer;
